...
fn run() -> Result<(), String> {
    ...
    let lift = buzz_protocol_lifter::lift_job_protocol(&source, authority, artifact, revision)
...
fn usage() -> String {
    "usage: buzz-protocol-lifter <source-path> <artifact-id> <authority> <revision>".to_owned()
}
